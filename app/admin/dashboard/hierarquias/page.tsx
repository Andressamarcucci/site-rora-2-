...
import { AlertCircle, Award, ChevronUp, ChevronDown } from "lucide-react"; // Importar explicitamente os ícones
import { Button } from "../../../../components/ui/button"; // Corrigir caminho de importação
...
export default function HierarquiasPage() {
  ...
  // Memoized filtered and sorted hierarchies
  const filteredHierarquias = useMemo(() => { 
    return hierarquias
    .filter(h => 
  ...
  }, [hierarquias, searchTerm, sortDirection])
...
export async function getCroppedImg(imageSrc: string, pixelCrop: any): Promise<string | null> {
  // Implemente a lógica para recortar a imagem aqui
  // Este é apenas um exemplo, você precisará adaptá-lo
